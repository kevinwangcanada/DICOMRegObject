...
const std::string vtkSlicerDICOMSpatialRegistrationReader::DICOMSPATIALREGISTRATIONREADER_DICOM_DATABASE_FILENAME = "/ctkDICOM.sql";
const std::string vtkSlicerDICOMSpatialRegistrationReader::DICOMSPATIALREGISTRATIONREADER_DICOM_CONNECTION_NAME = "Slicer";

vtkStandardNewMacro(vtkSlicerDICOMSpatialRegistrationReader);

//----------------------------------------------------------------------------
vtkSlicerDICOMSpatialRegistrationReader::vtkSlicerDICOMSpatialRegistrationReader()
{
  this->FileName = NULL;
...
//----------------------------------------------------------------------------
void vtkSlicerDICOMSpatialRegistrationReader::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void vtkSlicerDICOMSpatialRegistrationReader::Update()
{
  ...
  if ((this->FileName != NULL) && (strlen(this->FileName) > 0))
  {
    ...
    QString databaseFile = databaseDirectory + DICOMSPATIALREGISTRATIONREADER_DICOM_DATABASE_FILENAME.c_str();
...
//----------------------------------------------------------------------------
void vtkSlicerDICOMSpatialRegistrationReader::LoadSpatialRegistration(DcmDataset* dataset)
{
  this->LoadSpatialRegistrationSuccessful = false; 
  ...
  if (result.good())
  {
    ...
    for(unsigned long i=0; i<numOfRegistrationSequenceItems; i++)
    {
      ...
      {
        vtkDebugMacro("LoadSpatialRegistration: Found an invalid beam sequence in dataset");
        break;
      }
...
//----------------------------------------------------------------------------
void vtkSlicerDICOMSpatialRegistrationReader::LoadSpatialFiducials(DcmDataset* dataset)
{
  this->LoadSpatialFiducialsSuccessful = false; 
}
...
// TODO: not implemented yet...
//----------------------------------------------------------------------------
void vtkSlicerDICOMSpatialRegistrationReader::LoadDeformableSpatialRegistration(DcmDataset* dataset)
{
  this->LoadDeformableSpatialRegistrationSuccessful = false; 
}

//----------------------------------------------------------------------------
vtkMatrix4x4* vtkSlicerDICOMSpatialRegistrationReader::GetRegistrationMatrix()
{
