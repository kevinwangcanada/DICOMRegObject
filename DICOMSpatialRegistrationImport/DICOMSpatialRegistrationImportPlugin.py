...
class DICOMSpatialRegistrationImportPluginClass(DICOMPlugin):
  """ Spatial Registration specific interpretation code
  """

  def __init__(self,epsilon=0.01):
    super(DICOMSpatialRegistrationImportPluginClass,self).__init__()
    self.loadType = "REG"
...
#
# DICOMSpatialRegistrationImportPlugin
#

class DICOMSpatialRegistrationImportPlugin:
  """
  This class is the 'hook' for slicer to detect and recognize the plugin
  as a loadable scripted module
  """
  def __init__(self, parent):
    parent.title = "DICOM Spatial Registration Plugin"
    ...
    try:
      ...
      slicer.modules.dicomPlugins = {}
    slicer.modules.dicomPlugins['DICOMSpatialRegistrationImportPlugin'] = DICOMSpatialRegistrationImportPluginClass

#
# DICOMSpatialRegistrationImportWidget
#

class DICOMSpatialRegistrationImportWidget:
